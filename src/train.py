...
if __name__ == "__main__":
    ...
    # model = TransformerUNet((1, 32, 64, 128, 256, 512, 1024), True, 4, True).to(device)
    model = AttentionUNet((1, 32, 64, 128, 256, 512, 1024), True, True).to(device)
    # model = UNet((1, 32, 64, 128, 256, 512, 1024), True).to(device)
    # print(model)
    summary(model, (1, 128, 128), 4)
